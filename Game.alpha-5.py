...
'''revision notes:
05 worked through creating the pipes blit to the screen (used some of the values from other code sourcces so it has the same flow as the normal flappy bird)
...
def mainGame(movementInfo):
    ...
    while True:  # game loop - note:  everything in this loop is indented one tab
        ...
        for upperPipe, lowerPipe in zip(upperPipes, lowerPipes):
            ...
            SCREEN.blit(IMAGES['pipe'][1], (upperPipe['x'],upperPipe['y']))
